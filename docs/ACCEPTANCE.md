...
- 数据核对：原 202 条记录只改变上述 Workflow，没有记录增删，81006c7c 仍 COMPLETED/version315/18镜/90秒，全部故事和历史 Job 保持。104 个资产文件均可读取并保存散列。证据位于 ignored data/repairs/c33-keyframe-targets/，部署后的核对见收尾记录。
